...
const createAcademicDepartment = (0, catchAsync_1.default)((req, res, next) =>
...
const getAllAcademicDepartments = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicDepartment_service_1.AcademicDepartmentService.getAllDepartmentsFromDb(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const deleteAcademicDepartments = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
