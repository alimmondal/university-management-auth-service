...
const createSemester = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.SemesterService.createSemesterToDb(
...
const getAllSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      academicSemester_constant_1.FilterableSemesterFields
    );
    ...
    const result =
      yield academicSemester_service_1.SemesterService.getAllSemestersFromDb(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.SemesterService.getSingleSemesterToDb(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.SemesterService.updateSemesterToDb(
        id,
        updatedData
      );
    (0, sendResponse_1.default)(res, {
...
const deleteSemester = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
      yield academicSemester_service_1.SemesterService.deleteSemesterFromDb(id);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
      message: 'Academic semester updated successfully',
